...
struct OpenAIDashboardWebViewCacheTests {
    ...
    func `Reused page reset clears one shot scraper globals`() async throws {
        ...
        _ = try await lease.webView.evaluateJavaScript(
            ...
            window.__tokenusageUsageBreakdownJSON = '[{"day":"2026-04-19"}]';
            window.__tokenusageUsageBreakdownDebug = 'debug';
            true;
            """)
        ...
        let reset = try await lease.webView.evaluateJavaScript(
            """
            typeof window.__tokenusageDidScrollToCredits === 'undefined' &&
            typeof window.__tokenusageUsageBreakdownJSON === 'undefined' &&
            typeof window.__tokenusageUsageBreakdownDebug === 'undefined'
            """) as? Bool

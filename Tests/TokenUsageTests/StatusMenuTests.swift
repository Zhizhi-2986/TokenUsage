...
struct StatusMenuTests {
    ...
    func `overview tab omits contextual provider actions`() {
        ...
        #expect(titles.contains("About TokenUsage"))
...
extension StatusMenuTests {
    ...
    func `provider config changes preserve status items and autosave names`() throws {
        ...
        #expect(controller.statusItem.autosaveName == "tokenusage-merged")
        #expect(codexItem.autosaveName == "tokenusage-codex")
        ...
        #expect(controller.statusItems[.codex]?.autosaveName == "tokenusage-codex")
        #expect(controller.statusItems[.gemini]?.autosaveName == "tokenusage-gemini")
    }

...
struct AppGroupSupportTests {
    ...
    func `app group identifiers use resolved team-prefixed release and debug variants`() {
        #expect(
            AppGroupSupport.currentGroupID(teamID: "Y5PE65HELJ", bundleID: "com.steipete.tokenusage")
                == "Y5PE65HELJ.com.steipete.tokenusage")
        #expect(
            AppGroupSupport.currentGroupID(teamID: "ABCDE12345", bundleID: "com.steipete.tokenusage.debug")
                == "ABCDE12345.com.steipete.tokenusage.debug")
        #expect(
            AppGroupSupport.legacyGroupID(for: "com.steipete.tokenusage")
                == "group.com.steipete.tokenusage")
        #expect(
            AppGroupSupport.legacyGroupID(for: "com.steipete.tokenusage.debug")
                == "group.com.steipete.tokenusage.debug")
    }
    ...
    func `legacy migration copies snapshot once`() throws {
        ...
        let result = AppGroupSupport.migrateLegacyDataIfNeeded(
            bundleID: "com.steipete.tokenusage",

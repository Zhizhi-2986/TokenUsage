    ...
    static func unsupportedTarget(_ context: some MacroExpansionContext, node: SyntaxProtocol, macro: String) {
        context.diagnose(Diagnostic(
            ...
            message: Message(
                ...
                diagnosticID: MessageID(domain: "TokenUsageMacros", id: "unsupported_target"),
                severity: .error)))
    }
    ...
    static func missingDescriptor(_ context: some MacroExpansionContext, node: SyntaxProtocol, typeName: String) {
        context.diagnose(Diagnostic(
            ...
            message: Message(
                ...
                diagnosticID: MessageID(domain: "TokenUsageMacros", id: "missing_descriptor"),
                severity: .error)))
    }
    ...
    static func missingMakeDescriptor(_ context: some MacroExpansionContext, node: SyntaxProtocol, typeName: String) {
        context.diagnose(Diagnostic(
            ...
            message: Message(
                ...
                diagnosticID: MessageID(domain: "TokenUsageMacros", id: "missing_make_descriptor"),
                severity: .error)))
    }
    ...
    static func duplicateDescriptor(_ context: some MacroExpansionContext, node: SyntaxProtocol, typeName: String) {
        context.diagnose(Diagnostic(
            ...
            message: Message(
                ...
                diagnosticID: MessageID(domain: "TokenUsageMacros", id: "duplicate_descriptor"),
                severity: .error)))
    }
    ...
    static func missingInit(_ context: some MacroExpansionContext, node: SyntaxProtocol, typeName: String) {
        context.diagnose(Diagnostic(
            ...
            message: Message(
                ...
                diagnosticID: MessageID(domain: "TokenUsageMacros", id: "missing_init"),
                severity: .error)))
    }
}
...
public struct ProviderDescriptorRegistrationMacro: PeerMacro {
        ...
        in context: some MacroExpansionContext) throws -> [DeclSyntax]
    {
        ...
        let registerName = "_TokenUsageDescriptorRegistration_\(typeName)"
        return [
            DeclSyntax(
...
public struct ProviderImplementationRegistrationMacro: PeerMacro {
        ...
        in context: some MacroExpansionContext) throws -> [DeclSyntax]
    {
        ...
        let registerName = "_TokenUsageImplementationRegistration_\(typeName)"
        return [
            DeclSyntax(
...
@main
struct TokenUsageMacroPlugin: CompilerPlugin {

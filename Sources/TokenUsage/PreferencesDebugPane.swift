        ...
        ScrollView(.vertical, showsIndicators: true) {
            VStack(alignment: .leading, spacing: 20) {
                SettingsSection(title: "Logging") {
                    ...
                    HStack(alignment: .center, spacing: 12) {
                        ...
                        Picker("Verbosity", selection: self.$settings.debugLogLevel) {
                            ForEach(TokenUsageLog.Level.allCases) { level in
                    ...
                    Button {
                        NSWorkspace.shared.open(TokenUsageLog.fileLogURL)
                    } label: {
                    ...
                    caption: "Pick a pattern and replay it in the menu bar. \"Random\" keeps the existing behavior.")
                {
                    ...
                    Button {
                        NotificationCenter.default.post(name: .tokenusageDebugBlinkNow, object: nil)
                    } label: {

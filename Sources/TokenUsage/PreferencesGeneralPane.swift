            ...
            VStack(alignment: .leading, spacing: 16) {
                SettingsSection(contentSpacing: 12) {
                    ...
                    PreferenceToggleRow(
                        ...
                        subtitle: "Automatically opens TokenUsage when you start your Mac.",
                        ...
                        HStack(alignment: .top, spacing: 12) {
                            VStack(alignment: .leading, spacing: 4) {
                                Text("Refresh cadence")
                                    .font(.body)
                                Text("How often TokenUsage polls providers in the background.")
                                    .font(.footnote)
                                    .foregroundStyle(.tertiary)
                            }
                            Spacer()
                ...
                SettingsSection(contentSpacing: 12) {
                    HStack {
                        Spacer()
                        Button("Quit TokenUsage") { NSApp.terminate(nil) }

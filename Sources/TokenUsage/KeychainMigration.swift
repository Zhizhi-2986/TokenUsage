...
enum KeychainMigration {
    private static let log = TokenUsageLog.logger(LogCategories.keychainMigration)
    ...
    static let itemsToMigrate: [MigrationItem] = [
        MigrationItem(service: "com.steipete.TokenUsage", account: "codex-cookie"),
        MigrationItem(service: "com.steipete.TokenUsage", account: "claude-cookie"),
        MigrationItem(service: "com.steipete.TokenUsage", account: "cursor-cookie"),
        MigrationItem(service: "com.steipete.TokenUsage", account: "factory-cookie"),
        MigrationItem(service: "com.steipete.TokenUsage", account: "minimax-cookie"),
        MigrationItem(service: "com.steipete.TokenUsage", account: "minimax-api-token"),
        MigrationItem(service: "com.steipete.TokenUsage", account: "augment-cookie"),
        MigrationItem(service: "com.steipete.TokenUsage", account: "copilot-api-token"),
        MigrationItem(service: "com.steipete.TokenUsage", account: "zai-api-token"),
        MigrationItem(service: "com.steipete.TokenUsage", account: "synthetic-api-key"),
    ]

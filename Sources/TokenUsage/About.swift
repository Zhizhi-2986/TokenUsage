...
func showAbout() {
    ...
    credits.append(makeLink("GitHub", urlString: "https://github.com/steipete/TokenUsage"))
    credits.append(separator)
    credits.append(makeLink("Website", urlString: "https://tokenusage.app"))
    credits.append(separator)

...
extension UsageStore {
        ...
        samples: [PlanUtilizationSeriesSample])
    {
        ...
        TokenUsageLog.logger(LogCategories.confetti).info(
            "Weekly limit reset",
            metadata: [
        ...
        NotificationCenter.default.post(name: .tokenusageWeeklyLimitReset, object: event)
    }
        ...
        -> [String: WeeklyLimitResetDetectorState]
    {
        ...
        do {
            ...
            TokenUsageLog.logger(LogCategories.confetti).error(

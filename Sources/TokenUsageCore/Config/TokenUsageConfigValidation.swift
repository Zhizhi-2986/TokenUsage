...
public enum TokenUsageConfigIssueSeverity: String, Codable, Sendable {
    case warning
    case error
}

public struct TokenUsageConfigIssue: Codable, Sendable, Equatable {
    public let severity: TokenUsageConfigIssueSeverity
    ...
    public init(
        severity: TokenUsageConfigIssueSeverity,
...
public enum TokenUsageConfigValidator {
    public static func validate(_ config: TokenUsageConfig) -> [TokenUsageConfigIssue] {
        var issues: [TokenUsageConfigIssue] = []

        if config.version != TokenUsageConfig.currentVersion {
            issues.append(TokenUsageConfigIssue(
                severity: .error,
                provider: nil,
                field: "version",
    ...
    private static func validateProvider(_ entry: ProviderConfig, issues: inout [TokenUsageConfigIssue]) {

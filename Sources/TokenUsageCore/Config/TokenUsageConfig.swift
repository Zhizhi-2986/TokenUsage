...
public struct TokenUsageConfig: Codable, Sendable {
    ...
    public static func makeDefault(
        metadata: [UsageProvider: ProviderMetadata] = ProviderDescriptorRegistry.metadata) -> TokenUsageConfig
    {
        ...
        return TokenUsageConfig(version: Self.currentVersion, providers: providers)
    }

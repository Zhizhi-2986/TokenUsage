...
public enum AppGroupSupport {
    ...
    public static let teamIDInfoKey = "TokenUsageTeamID"
    public static let legacyReleaseGroupID = "group.com.steipete.tokenusage"
    public static let legacyDebugGroupID = "group.com.steipete.tokenusage.debug"
    ...
    static func currentGroupID(teamID: String, bundleID: String?) -> String {
        let base = "\(teamID).com.steipete.tokenusage"
        ...
        -> URL
    {
        ...
        let directory = base.appendingPathComponent("TokenUsage", isDirectory: true)

...
public enum KeychainCacheStore {
    ...
    private static let log = TokenUsageLog.logger(LogCategories.keychainCache)
    private static let cacheService = "com.steipete.tokenusage.cache"
    private static let cacheLabel = "TokenUsage Cache"

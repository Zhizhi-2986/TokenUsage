...
public struct OpenRouterUsageFetcher: Sendable {
    private static let log = TokenUsageLog.logger(LogCategories.openRouterUsage)
    ...
    private static let debugFullErrorBodiesEnvKey = "TOKENUSAGE_DEBUG_OPENROUTER_ERROR_BODIES"
    private static let httpRefererEnvKey = "OPENROUTER_HTTP_REFERER"
    private static let clientTitleEnvKey = "OPENROUTER_X_TITLE"
    private static let defaultClientTitle = "TokenUsage"

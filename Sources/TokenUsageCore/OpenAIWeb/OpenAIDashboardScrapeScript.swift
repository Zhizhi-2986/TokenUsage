...
let openAIDashboardScrapeScript = """
    ...
    (() => {
      ...
      const usageBreakdownJSON = (() => {
        try {
          if (window.__tokenusageUsageBreakdownJSON) return window.__tokenusageUsageBreakdownJSON;
          ...
          window.__tokenusageUsageBreakdownJSON = json;
          window.__tokenusageUsageBreakdownDebug = json ? null : JSON.stringify(debug);
          return json;
        } catch {
          return null;
        }
      ...
      const usageBreakdownDebug = (() => {
        try {
          return window.__tokenusageUsageBreakdownDebug || null;
        } catch {
          return null;
        }
      })();
      ...
      try {
        ...
        if (header) {
          ...
          if (rows.length === 0 && !window.__tokenusageDidScrollToCredits) {
            window.__tokenusageDidScrollToCredits = true;
        ...
        } else if (rows.length === 0 && !window.__tokenusageDidScrollToCredits && scrollHeight > viewportHeight * 1.5) {
          rows = allTableRows();
          if (rows.length > 0) {
            creditsHeaderPresent = true;
        ...
        if (rows.length === 0 && !window.__tokenusageDidScrollToCredits && scrollHeight > viewportHeight * 1.5) {

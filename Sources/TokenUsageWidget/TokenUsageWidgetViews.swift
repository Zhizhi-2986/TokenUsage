...
struct TokenUsageUsageWidgetView: View {
    @Environment(\.widgetFamily) private var family
    let entry: TokenUsageWidgetEntry
...
struct TokenUsageHistoryWidgetView: View {
    @Environment(\.widgetFamily) private var family
    let entry: TokenUsageWidgetEntry
...
struct TokenUsageCompactWidgetView: View {
...
struct TokenUsageSwitcherWidgetView: View {
    @Environment(\.widgetFamily) private var family
    let entry: TokenUsageSwitcherEntry

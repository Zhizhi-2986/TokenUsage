...
if [[ -z "$version_content" ]]; then
  echo "<h2>TokenUsage $VERSION</h2>"
  echo "<p>Latest TokenUsage update.</p>"
  echo "<p><a href=\"https://github.com/steipete/TokenUsage/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi

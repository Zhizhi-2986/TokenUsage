...
- `Sources/TokenUsageCore`: provider descriptors + fetch strategies + probes + parsing + shared utilities.
- `Sources/TokenUsage`: UI/state + provider implementations (settings/login/menu hooks only).
...
- `Sources/TokenUsageCore/Providers/<ProviderID>/`
...
- `Sources/TokenUsage/Providers/<ProviderID>/`
...
Checklist:
- Add `UsageProvider` case in `Sources/TokenUsageCore/Providers/Providers.swift`.
- Create `Sources/TokenUsageCore/Providers/<ProviderID>/`:
...
- Add `Sources/TokenUsage/Providers/<ProviderID>/<ProviderID>ProviderImplementation.swift`:

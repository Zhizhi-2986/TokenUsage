...
Vertex AI Claude usage is logged to the same local files as direct Anthropic API usage (`~/.claude/projects/`). TokenUsage identifies Vertex AI entries using two methods:

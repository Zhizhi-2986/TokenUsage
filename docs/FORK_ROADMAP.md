...
# TokenUsage Fork Roadmap

This document outlines the development roadmap for the TokenUsage fork maintained by Brandon Charleson.
...
1. **Replace print() with proper logging**
   - Use `TokenUsageLog.logger("augment")` throughout
...
**Files to Modify:**
- `Sources/TokenUsageCore/Providers/Augment/AugmentStatusProbe.swift`
- `Sources/TokenUsageCore/Providers/Augment/AugmentSessionKeepalive.swift`
- `Sources/TokenUsage/UsageStore.swift` (debug pane)
...
**Files to Create:**
- `Sources/TokenUsageCore/AccountManager.swift`
- `Sources/TokenUsageCore/Providers/Augment/AugmentAccountManager.swift`
- `Sources/TokenUsage/AccountSwitcherView.swift`

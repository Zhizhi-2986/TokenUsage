...
flowchart TD
    ...
    I --> J{"Refresh status"}
    J -- "200" --> K["Save refreshed creds to TokenUsage keychain cache + memory"]
...
```mermaid
flowchart TD
    A["load(...)"] --> B["Environment token (TOKENUSAGE_CLAUDE_OAUTH_TOKEN)"]
    B -->|miss| C["Memory cache (valid + unexpired)"]
    C -->|miss| D["TokenUsage keychain cache: com.steipete.tokenusage.cache/oauth.claude"]
...
- `/Users/ratulsarna/Developer/staipete/TokenUsage/Sources/TokenUsageCore/Providers/Claude/ClaudeUsageFetcher.swift`
- `/Users/ratulsarna/Developer/staipete/TokenUsage/Sources/TokenUsageCore/Providers/Claude/ClaudeProviderDescriptor.swift`
- `/Users/ratulsarna/Developer/staipete/TokenUsage/Sources/TokenUsageCore/Providers/Claude/ClaudeOAuth/ClaudeOAuthCredentials.swift`
- `/Users/ratulsarna/Developer/staipete/TokenUsage/Sources/TokenUsageCore/Providers/Claude/ClaudeOAuth/ClaudeOAuthKeychainAccessGate.swift`
- `/Users/ratulsarna/Developer/staipete/TokenUsage/Sources/TokenUsageCore/Providers/Claude/ClaudeOAuth/ClaudeOAuthRefreshFailureGate.swift`
- `/Users/ratulsarna/Developer/staipete/TokenUsage/Sources/TokenUsageCore/KeychainAccessPreflight.swift`
- `/Users/ratulsarna/Developer/staipete/TokenUsage/Sources/TokenUsageCore/KeychainNoUIQuery.swift`
- `/Users/ratulsarna/Developer/staipete/TokenUsage/Sources/TokenUsageCore/BrowserCookieImportOrder.swift`
- `/Users/ratulsarna/Developer/staipete/TokenUsage/Sources/TokenUsageCore/BrowserCookieAccessGate.swift`

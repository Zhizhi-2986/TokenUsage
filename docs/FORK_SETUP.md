...
**One-time setup for managing your TokenUsage fork with multiple upstreams**
...
git remote -v
# Should show: origin  git@github.com:topoffunnel/TokenUsage.git
...
git remote -v
# Should show:
# origin    git@github.com:topoffunnel/TokenUsage.git (fetch/push)
# upstream  https://github.com/steipete/TokenUsage.git (fetch/push)
...
Files changed:
 ...
 Tests/TokenUsageTests/AugmentStatusProbeTests.swift  |  88 deletions
```
...
Implemented independently using TokenUsage architecture."
```
...
# Go to: https://github.com/steipete/TokenUsage

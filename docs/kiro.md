...
1) **CLI command** (primary and only strategy)
   ...
   - Output is ANSI-decorated; TokenUsage strips escape sequences before parsing.
...
- `Sources/TokenUsageCore/Providers/Kiro/KiroProviderDescriptor.swift`
- `Sources/TokenUsageCore/Providers/Kiro/KiroStatusProbe.swift`
- `Sources/TokenUsage/Providers/Kiro/KiroProviderImplementation.swift`

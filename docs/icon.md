---
summary: "Convert macOS .icon bundles to TokenUsage .icns via Scripts/build_icon.sh and ictool."
read_when:
  - Updating the TokenUsage app icon or asset pipeline
...
## Script
`Scripts/build_icon.sh ICON.icon TokenUsage [outdir]`

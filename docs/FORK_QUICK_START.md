...
# TokenUsage Fork - Quick Start Guide
...
**Fork Repository:** https://github.com/topoffunnel/TokenUsage
...
cd /Users/steipete/Projects/tokenusage && open -n /Users/steipete/Projects/tokenusage/TokenUsage.app
```
...
### Source Code
- `Sources/TokenUsage/` - Swift 6 menu bar app
- `Sources/TokenUsageCore/` - Core logic, providers, utilities
- `Sources/TokenUsageCore/Providers/Augment/` - Augment provider implementation
- `Tests/TokenUsageTests/` - XCTest coverage
...
1. Enable debug logging: `export TOKENUSAGE_LOG_LEVEL=debug`
2. Check Console.app for "com.steipete.tokenusage"
...
- If you still see prompts, check `Sources/TokenUsageCore/Keychain/`
...
1. Start with `Sources/TokenUsage/CodexbarApp.swift` - App entry point
2. Review `Sources/TokenUsageCore/UsageStore.swift` - Main state management
3. Check `Sources/TokenUsageCore/Providers/` - Provider implementations
...
4. Submit PR to `topoffunnel/TokenUsage`

### To Upstream
1. Check if feature benefits all users
2. Create PR to `steipete/TokenUsage`
...
- GitHub Issues: https://github.com/topoffunnel/TokenUsage/issues
- Email: [your-email]@topoffunnel.com

### Upstream Issues
- GitHub Issues: https://github.com/steipete/TokenUsage/issues
